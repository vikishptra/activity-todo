...
func (r *ginController) rundeletetodoHandler() gin.HandlerFunc {

	type InportRequest = rundeletetodo.InportRequest
	type InportResponse = rundeletetodo.InportResponse
